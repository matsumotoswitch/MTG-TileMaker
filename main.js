  ...
  rows.forEach((rowItems, rowIdx) => {
    ...
    rowItems.forEach((cardData, colIdx) => {
      ...
      card.innerHTML = `
        ...
        <button class="rotate-btn" title="右に90度回転" style="pointer-events:auto; position:absolute; bottom:5px; left:5px; z-index:10; background:rgba(0,0,0,0.6); color:white; border:none; border-radius:4px; padding:5px; cursor:pointer; display:flex;">
